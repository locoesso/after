...
echo "/dev/disk/by-uuid/10B07312B072FE12                       /mnt/data      auto   nosuid,nodev,nofail,x-gvfs-show,x-gvfs-name=Data 0 0" | sudo tee -a /etc/fstab
