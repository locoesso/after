...
#/dev/disk/by-uuid/4A40E30A40E2FB97                              /mnt/windows_10 auto nosuid,nodev,nofail,noauto,x-udisks-auth,x-gvfs-name=Windows10 0 0
#/dev/disk/by-uuid/BE20DE5B20DE19EB                              /mnt/windows_boot auto nosuid,nodev,nofail,noauto,x-udisks-auth,x-gvfs-name=WindowsBoot 0 0
