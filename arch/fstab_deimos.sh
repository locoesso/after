...
#echo "//phobos/Altair		/media/altair		cifs	 
comment=systemd.automount,iocharset=utf8,credentials=$HOME/.smbcredentials,uid=1000	0	0" | sudo tee -a /etc/fstab
#echo "//phobos/Betelgeuse	/media/betelgeuse	cifs	
comment=systemd.automount,iocharset=utf8,credentials=$HOME/.smbcredentials,uid=1000	0	0" | sudo tee -a /etc/fstab
#echo "/dev/disk/by-uuid/74911197-06fb-442d-aa97-ea63d6f16ea4 /mnt/apophis auto 
nosuid,nodev,nofail,x-gvfs-show,x-gvfs-name=Apophis 0 0" | sudo tee -a /etc/fstab
